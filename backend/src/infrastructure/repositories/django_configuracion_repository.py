...
def _build_portal_payload(empresa, apariencia, header, footer, menus, redes) -> dict:
    ...
    return {
        ...
        'colores': {
            ...
            'terciario': (apariencia.color_terciario if apariencia else None) or '#2563EB',
        },
        'tipografia': {
        ...
        'header': {
            ...
            'colorFondo': (header.color_fondo if header else None) or '#0f172a',
            'colorTexto': (header.color_texto if header else None) or '#ffffff',
        ...
        'footer': {
            ...
            'colorFondo': (footer.color_fondo if footer else None) or '#0f172a',
            'colorTexto': (footer.color_texto if footer else None) or '#e2e8f0',
            'contacto': {
